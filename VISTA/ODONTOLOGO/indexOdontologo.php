        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModalScrollable">Atendida</button></td>
                </tr>
                <?php }?>
            </tbody>
        </table>
  ...
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        minima <img src="https://s3.amazonaws.com/uifaces/faces/twitter/themikenagle/128.jpg">
      </div>
